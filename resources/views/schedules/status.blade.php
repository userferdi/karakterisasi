...
<script>
  ...
  $('#table_approved').DataTable({
    ...
    columns: [
      {title: 'No', data: 'DT_RowIndex', name: 'no', orderable:false, width: '5%', className: 'dt-center'},
      {title: 'No Registrasi', data: 'no_regis', name: 'no_regis', width: '13.75%', className: 'dt-head-center'},
      {title: 'Nama', data: 'user', name: 'user', width: '17.5%', className: 'dt-head-center'},
      {title: 'Alat', data: 'tool', name: 'tool', width: '17.5%', className: 'dt-head-center'},
      {title: 'Tanggal', data: 'date', name: 'date', width: '11.25%', className: 'dt-center'},
      {title: 'Waktu', data: 'time', name: 'time', width: '20%', className: 'dt-center'},
      {title: 'Hadir', data: 'hadir', name: 'hadir', orderable:false, width: '5%', className: 'dt-center'},
    ],
  });
