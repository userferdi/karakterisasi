...
@section('title', 'FINDER · Approved by Lecturer')

@section('content')
<h2 style="padding-top:10px;"><strong>Approved by Lecturer</strong></h2>
<div class="row">
  <div class="col-lg-12">
    <div class="card" >
      <div class="card-body">
...
<script>
  $('#table').DataTable({
    ...
    columns: [
      ...
      {title: 'Hadir', data: 'attend', name: 'attend', orderable:false, className: 'dt-center'},
