...
<body size="A4">
	...
	<div class="row">
		...
		<div class="header-2" style="padding-left: 8.5cm; margin-right: -1cm">
			<p style="font-weight: 600;">Nomor &nbsp; &nbsp;: {{$model->no_invoice}}</p>
	...
	<table class="table footer-1" width="100%">
	    <tr>
	        <td class="pt" width="50%">INFORMASI PEMBAYARAN</td>
	...
	<div style="padding-top: 1.5cm; margin-bottom: -2.55cm;">
