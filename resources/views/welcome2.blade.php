    ...
    <div class="row">
      <ol>
        <li>
          <h4>Layanan Login</h4>
          <h5>Silakan 
            <a href="{{ route('login') }}">Login</a> dengan memasukkan email dan password yang Anda buat. Untuk melakukan booking alat, pilih menu Registrasi Penggunaan Alat setelah Anda Log-in.
          </h5>
        </li><br>
        <li>
          <h4>Daftar Akun</h4>
